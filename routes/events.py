# Registers Socket.IO events for real-time communication.
...
def register_events(socketio):
        ...
        if chat_type == 'user':
            ...
            if course:
                ...
                for uid in users_to_notify:
                    ...
                    if is_announcement:
                        notif_msg = "Instructor posted a new announcement."
    ...
    def handle_edit_message(data):
        ...
        if msg and msg.sender_id == current_user.id:
            ...
            emit('message_edited', payload, room=room)
            if chat_type == 'user':
    ...
    def handle_delete_message(data):
        ...
        if msg and msg.sender_id == current_user.id:
            ...
            emit('message_deleted', payload, room=room)
            if chat_type == 'user':
    ...
    def handle_react_message(data):
        ...
        chat_type = 'course' if msg.course_id else 'user'
        chat_id = msg.course_id if msg.course_id else (
        ...
        if room:
            emit('message_reacted', payload, room=room)
        if chat_type == 'user':
    ...
    def handle_pin_message(data):
        ...
        if room:
            emit('message_pinned', payload, room=room)
        if chat_type == 'user':
