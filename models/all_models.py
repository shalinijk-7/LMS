...
class Role(db.Model):
    """Represents a user role (e.g., admin, instructor, student)."""
    __tablename__ = 'roles'
...
class Progress(db.Model):
    """Tracks completion status of a lesson for a student."""
...
class Video(db.Model):
    """Stores video information for a lesson."""
...
class StudyMaterial(db.Model):
    """Downloadable materials for a lesson."""
...
class Quiz(db.Model):
    """Quiz associated with a course or lesson."""
...
class DiscussionThread(db.Model):
    """Top-level forum thread in a course."""
...
class Message(db.Model):
    """Direct or course group chat message."""
...
class CourseChatReadStatus(db.Model):
    """Tracks last read message for a user in a course chat."""
...
class StudentProgress(db.Model):
    """Aggregated progress metrics for a student in a course."""
...
class CourseCompletion(db.Model):
    """Records full course completion."""
...
class Payment(db.Model):
    """Payment transaction for a course."""
...
class PurchaseHistory(db.Model):
    """Links a payment to a student and course."""
